...
export const makeHostMaker = ({
  ...
  const makeIdentifiedHost = async (
    ...
    const invite = async (guestName, invitationName = guestName) => {
      ...
      const guestFormulaIdentifier = await provideGuestFormulaIdentifier(guestName);
      if (guestFormulaIdentifier === undefined) {
    ...
    const nonceLocator = () => provideValueForFormulaIdentifier(nonceLocatorFormulaIdentifier);
